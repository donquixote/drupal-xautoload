...
/**
 * A "scenario" tells us which modules are available in a VirtualDrupal install.
 * It does not know anything about database or runtime state.
 */
interface DrupalScenarioInterface {
  ...
  /**
   * @return true[]
   *   List of bootstrap modules, whether installed or not.
   */
