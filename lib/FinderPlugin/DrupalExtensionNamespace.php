 ...
 * for a base class.
 */
class xautoload_FinderPlugin_DrupalExtensionNamespace implements xautoload_FinderPlugin_ExtendedInterface {
   ...
   * @param string $type
   *   E.g. 'theme' or 'module'.
   * @param xautoload_ClassFinder_Helper_Map $namespace_map
   * @param xautoload_ClassFinder_Helper_Map $prefix_map
