...
class xautoload_DrupalSystem_Real implements xautoload_DrupalSystem_Interface {
  ...
  function getActiveExtensions() {
    ...
    return db_query("SELECT name, type from {system} WHERE status = 1")->fetchAllKeyed();
  }
}
